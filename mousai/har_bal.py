...
def hb_time(sdfunc, x0=None, omega=1, method='newton_krylov', num_harmonics=1,
    ...
    """
    try:
        solver_method = getattr(__import__('scipy.optimize', fromlist=[''])
                                , method)
    ...
    try:
        ...
        x = solver_method(hb_err, x0, **kwargs)
    except Exception as ex:  # Catches and raises errors.
...
def time_errors(sdfunc, x0=None, omega=1, num_harmonics=1, num_variables=None,
    ...
    r"""Harmonic balance equation errors first and second order ODEs.
